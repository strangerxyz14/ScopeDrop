...
main() {
    ...
    echo "Next Steps:"
    echo "=========================================="
    echo "1. Update .env file with your frontend variables:"
    echo "   - VITE_SUPABASE_URL"
    echo "   - VITE_SUPABASE_ANON_KEY"
    echo ""
    echo "   (Frontend is dumb: no VITE_* keys for News/LLMs.)"
    echo ""
    echo "2. Configure backend secrets for Edge Functions (Supabase):"
    echo "   - SUPABASE_SERVICE_ROLE_KEY"
    echo "   - GEMINI_API_KEY"
    echo "   - NEWS_API_KEY (or your chosen scout provider key)"
    echo ""
